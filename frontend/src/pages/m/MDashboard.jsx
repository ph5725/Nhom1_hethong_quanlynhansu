...
const MDashboard = () => {
  ...
  const API_URL = 'http://127.0.0.1:8000/api/m/dashboard/manager';
  ...
  return (
    <div className="user-container">
        <div style={{ paddingLeft: '40px', width: '100%', maxWidth: '900px', marginBottom: '24px', textAlign: 'left' }}>
          <h1 className="page-title" style={{ margin: 0, textAlign: 'left' }}>Management Dashboard</h1>
      ...
      <div className="card-container">
        ...
        <div className="dashboard-card">
          ...
          <div className="card-value">{data.total_leaves || 0}</div>
        </div>
        <div className="dashboard-card">
