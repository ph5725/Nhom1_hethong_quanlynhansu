  ...
  useEffect(() => {
    ...
    const fetchLeaveType = async () => {
      try {
        ...
        setServerError('Failed to fetch leave type');
      }
    };
    fetchLeaveType();
  }, [id, roleApi]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.status === 422) {
        ...
        setServerError('Failed to update leave type');
      }
    }
  };
  ...
  return (
    <div className="user-container">
      <div style={{ paddingLeft: '40px', width: '100%', maxWidth: '900px', marginBottom: '24px', textAlign: 'left' }}>
        <h1 className="page-title" style={{ margin: 0, textAlign: 'left' }}>Edit Leave Type</h1>
