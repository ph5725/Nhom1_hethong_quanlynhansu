  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (err.response && err.response.status === 422) {
        ...
        setServerError('Failed to create insurance type');
      }
    }
  };
  ...
  return (
    <div className="user-container">
      <div style={{ paddingLeft: '40px', width: '100%', maxWidth: '900px', marginBottom: '24px', textAlign: 'left' }}>
        <h1 className="page-title" style={{ margin: 0, textAlign: 'left' }}>Add New Insurance Type</h1>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <div className="form-buttons">
            <Button
              ...
              onClick={() => navigate('/admin/insurance-types')}
            >
              Cancel
            </Button>
...
export default InsuranceTypeCreate;